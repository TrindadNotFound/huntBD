    ...
    ?>
                ...
                <div class='opcions_box'>
                    <ul class='list_options'>
                        <li><a href='p_gestArmas.php'>Gerir tipos de armas</a></li>
                        <li><a href='p_gestTipoEventos.php'>Gerir tipos de eventos</a></li>
                        <li><a href='p_gestAnimais.php'>Gerir especies de caça</a></li>
                    </ul>
                </div>
    <?php
            }
